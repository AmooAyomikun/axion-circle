...
const getUrgencyIcon = (urgency) => {
  ...
  if (u.includes('critical') || u.includes('very urgent')) return <AlertCircle className="w-4 h-4 text-red-600" />;
  if (u.includes('moderate') || u.includes('urgent')) return <AlertCircle className="w-4 h-4 text-orange-600" />;
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-8">
          ...
          <div className="sm:hidden flex flex-col pb-6 px-4">
            ...
            <div className="flex items-center justify-between mb-6 pl-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={handleShare} className="flex items-center gap-1.5 text-black hover:text-primary transition-colors px-3 py-1.5 border border-white-stroke rounded-lg text-[11px] font-bold bg-white shadow-sm ml-1" aria-label="Share Report">
            ...
            <div className="mb-6">
              ...
              <div className="rounded-2xl overflow-hidden shadow-sm border border-white-stroke relative">
                ...
                <div className="h-[180px] w-full bg-white-bg2 z-0 relative">
                  <Suspense fallback={<div className="w-full h-full bg-white-stroke animate-pulse"></div>}>
            ...
            <div className="bg-[#F8F9FA] border border-white-stroke rounded-2xl p-6 flex flex-col items-center text-center shadow-sm">
              <Gift className="w-10 h-10 text-[#D97706] mb-3" strokeWidth={1.5} />
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between min-h-[124px] py-6 w-full mb-6 gap-4">
            ...
            <div className="flex flex-col items-end gap-[10px] shrink-0">
              ...
              {/* Rewards Badge */}
              <div className="flex items-center gap-[6px]">
                <Star className="w-[14px] h-[14px] text-[#D97706] fill-[#D97706]" />
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-[31px] self-stretch w-full">
            ...
            <div className="w-full flex-1 max-w-full lg:max-w-[650px] xl:max-w-[700px]">
              ...
              <div className="w-full h-[180px] rounded-xl overflow-hidden border border-white-stroke z-0 relative mb-3 bg-white-bg2">
                <Suspense fallback={<div className="w-full h-full bg-white-stroke animate-pulse"></div>}>
                  <ReportDetailMap report={report} geoDistrict={geoDistrict} geoAddress={geoAddress} />
                </Suspense>
              </div>
